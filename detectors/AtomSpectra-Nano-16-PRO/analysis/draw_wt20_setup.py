...
ax.set_aspect("equal")
ax.axis("off")
ax.set_title("Поперёк стержней (плоскость Z = 0): прибор лежит на пенале "
             "СТОРОНОЙ ПЛАТЫ — излучение входит через дно корпуса",
             fontsize=9.5, pad=6)
...
fig.text(0.045, 0.952,
         "ПО ЭТИКЕТКЕ ПАЧКИ: «Tungsten Electrodes 3.2 mm × 175 mm, 10 Pieces, "
         "2%%Thoriated(WT20), ANSI/AWS A5.12M-98, ISO 6848». "
         "ПО СЛОВАМ ОПЕРАТОРА: прибор лежит стороной платы,\nвдоль электродов, "
         "по центру; крышка пенала — акрил %s мм; прибор СТОИТ НА НОЖКАХ "
         "(силиконовые пуговички 3–4 мм по углам). "
         "ДОПУЩЕНИЯ: шаг укладки %s мм (один слой, вплотную), зазор %s мм, "
         "плотность ThO2 %s г/см³.\n"
         "Расчётная плотность сплава %s г/см³ (правило смеси), объём пачки "
         "%s см³, масса %s г. Тория в пачке %s г при номинале 2 %% масс. "
         "(допуск ISO 6848 — 1,70…2,20 %%)."
