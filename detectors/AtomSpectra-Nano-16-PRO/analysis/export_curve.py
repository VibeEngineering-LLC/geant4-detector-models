...
6,29 %. Закон ПШПВ(E) = ПШПВ(662)*sqrt(E/661,657) — приближение по одной
...
def main():
    ...
    for f in files:
        ...
        # эмпирически неверна: на 122,061 канальный ряд 118,5–121,5 идёт
        # 1121 / 1136 / 807 / 521, то есть к линии падает. Хуже того,
        ...
        # завышался на +26,9 % (59,541), +34,0 % (122,061), +84,0 % (661,657),
        ...
        # наблюдаемы оба канала, N(kc−1)/N(kc−2) = 0,868 (59,541) и 0,646
        # (122,061). Значит на 23 целых узлах вычет по kc−2 остаётся ОЦЕНКОЙ, а
        # не измерением, и односторонность там уменьшена, но не снята: kc−1
        # наблюдаем только на шести дробных узлах из 29.
        #
        ...
        # внутри одного узла): −0,46 % (40), −0,08 % (50), +0,22 % (80),
        # +0,12 % (100), далее |·| < 0,06 %. Оценка аудита кода 06.08.2026
