...
трёх результатов информативнее точности одного.</p>
...
<h2 id="vessels">Расхождение принадлежит моделям сосудов, а не детектору</h2>
...
точки. Разброс точек у маринелли и «Денты» до 20 %% принадлежит самим точкам:
...
отсутствующие в расчёте. Механизма два, и ни один не сведён к числу.</p>
</div>
</div>
...
энергии срезает часть пика и заводит полки фона на склон; обе ошибки смещают
...
общих ширине окна и устройстве полок. У линии в бленде центроида есть центр
...
остаётся одна годная — 2614,5 кэВ. Бленды разбирает связанная деконволюция:
