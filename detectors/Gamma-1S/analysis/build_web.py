...
def spectraline_check():
    ...
    return (
        ...
        '<p><b>Различие в охвате.</b> Наша модель Монте-Карло учитывает фон, '
        'ослабленный защитой, и процессы в самой защите (рассеяние и др.); при '
        'сравнении кривых в СпектраЛайн эти вклады не учитывались.</p>'
