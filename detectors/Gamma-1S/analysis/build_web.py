...
def answer_card(kit):
    ...
    return (
        ...
        '<p><b>Главный результат: пригодна ли цепочка обработки спектра.</b> '
        ...
        '25 см — %s). Детектор и алгоритмы анализа спектра на известном '
        'ответе воспроизводят активность.</p>'
        ...
        'множитель детектора и не ошибка алгоритмов (они проверены точечной '
        'геометрией), а модели самих сосудов, построенные по неполным '
        'чертежам. Разбор — в разделах «Сводка» и «Вывод».</p>'
        '<p>Практический вывод: цепочка обработки спектра — калибровка, поиск '
        'пиков, съём площади, деконволюция, усреднение активности — на '
        'поверенном комплекте работает; перенос метода на объёмный сосуд '
        'требует его достоверной геометрии.</p>'
        '</div>'
        % (ru(pt_worst, 0),
