...
# Зонная аппроксимация — в curvefit.py (модуль без побочных эффектов:
# отсюда её импортируют скрипты, которым расчётные спектры не нужны).
from curvefit import zoned_fit  # noqa: E402
