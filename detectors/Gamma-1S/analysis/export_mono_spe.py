...
# Моно-линии полной геометрии, доступные в рабочем каталоге, и опорная
# энергия для съёма истинного пика.
MONO = {122.061: "scat_p5_full_E122.1.csv",
        165.9: "scat_p5_full_E165.9.csv",
        661.657: "scat_p5_full_E661.7.csv",
        2614.511: "scat_p5_full_E2614.5.csv"}
GEOM = "Точечная-5см"
