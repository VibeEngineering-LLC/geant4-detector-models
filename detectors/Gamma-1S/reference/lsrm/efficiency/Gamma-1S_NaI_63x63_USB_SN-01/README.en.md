...
**Gamma-1C NaI 63×63 USB No. SN-01** detector, supplied by the
...
|---|---|---|---|---|
| **Marinelli** | 1000 ml | 0 (around detector) | OISN-16 ρ=1.6 | Large volume environmental samples |
| **Petri dish** | 60 ml | 0 (on top) | OISN-16 ρ=1.6 | Thin-layer samples (filters, swipes) |
| **"Denta"** | 120 ml | 0 (close geom.) | OISN-16 ρ=1.6 | Small dense samples |
| **Point source, 5 cm** | 0 | 5 cm | — | Calibration point source close |
| **Point source, 25 cm** | 0 | 25 cm | — | Calibration point source far |

The "OISN-16" matrix in volumetric geometries is the standard
