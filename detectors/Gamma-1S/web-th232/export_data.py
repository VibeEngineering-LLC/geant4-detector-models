...
SUM_PEAKS = [
    ...
    # ниже её и не добавит (проверка Esum>E_FIT_HI отбросит запись), но
    # УХОД вероятности из одиночных пиков 583 и 2614 в эту сумму —
    # реальная физика независимо от того, попадает ли сама сумма в
    # диапазон. Запись нужна ради этого истощения (R78/R85, #166).
    (583.187, 2614.511, "Tl208", 85.0, 99.754,
