...
def main():
    ...
    # G2 (независимый аудит, 16.08): «сумма» ОБЯЗАНА браться из того же `total`, что
    ...
    for name, lo, hi in WINDOWS:
        ...
        # складываются, амплитуда входит квадратом. G1 (независимый аудит): мюонная
        ...
        sd = np.sqrt(var_sum)
        tot = total[m].sum()
        # Независимый аудит, 17.08: при отсутствии мюонных данных печатать ПРОЧЕРК, а не
    ...
    with open(out, "w", encoding="utf-8") as f:
        ...
        # G3 (независимый аудит, 16.08): cps_total = ЕРН + мюоны, поэтому баланс
