...
# Что показало приложение RadiaCode v1.52.03 — со СКРИНШОТА оператора
# (17.08.2026, фото экрана вместе со спектром): «834 Бк / 3.39к Бк/кг ±1,15 %»,
# масса 246 г, геометрия «Маринелли авторская», фон «Фон домик», набор
# 1 сут 07:37:28. Сходимость проверена: 834 / 0,246 = 3390 Бк/кг.
# Прежнее значение 3340 записано было по памяти и на 1,5 % расходится со
# скриншотом — заменено на приборное.
APP_BQ = 834.0           # Бк, полная активность пробы по приложению
APP_SD_REL = 0.0115      # ±1,15 % — тоже с экрана
APP_BQ_PER_KG = 3390.0   # 834 Бк / 0,246 кг
